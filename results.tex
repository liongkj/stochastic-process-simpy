...
\begin{minipage}{\textwidth}
	\begin{center}
    \includegraphics[width=0.7\columnwidth]{images/utilization_percentage.png}
...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{$W_Q$ = Average time in system}\label{bar}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{$W_Q$ = Average time spend waiting}\label{bar}
\end{minipage}
...
\noindent
\begin{minipage}{\textwidth}
	\includegraphics[width=\textwidth]{images/service_distribution.png}
	\captionof{figure}{= Service Times and its distribution}\label{fig:service}
\end{minipage}
